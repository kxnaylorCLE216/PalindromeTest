	...
	private static void startChromeDriver() {
		...
		if(headless.equals("true")) {
            chromeOptions.addArguments("--headless");
					...
					chromeOptions.addArguments("--disable-extensions"); // disabling
	...
	private static void startFireFoxDriver() {
		...
		if(headless.equals("true")) {
        	...
        	ffOptions.addArguments("--disable-infobars");
					ffOptions.addArguments("--disable-extensions"); // disabling
					ffOptions.addArguments("--disable-dev-shm-usage"); // overcome limited resource problems
					ffOptions.addArguments("--no-sandbox"); // Bypass OS security
        }
